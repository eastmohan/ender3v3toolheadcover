**3/17/2026** <br>
**Made Wiring Diagram - 1h** <br>
I made the wiring diagram. This was a lot more complicated than I anticipated because I initally thought I was just going to power the LED rings from the ESP 32 C3 supermini, but after doing some research, I decided this could be prone to voltage drops and since there was already extra ports on the USB hub, I decided to just split a USB cable to provide 5 volt/vcc and gnd to the LED rings and use a seperate USBC cable to power and send code to the ESP. I then connected the GPIO2 pin on the ESP to the data in pin on the ring light.
<br>
I've also decided I'm going to try to use wifi to control the LEDs (using the esp32 of course), so I'll try to make a nice interface for controlling it so the user can interact with the controls and it automatically updates the code and sends to the esp.
![alt text](image.png)

**3/10/2026** <br>
**Finished 3D Model - 2.3h** <br>
...
![img14](journal_images/1773172581383-znbry5.png)
![img13](journal_images/1773172593952-fcfbbe.png)
<br> <br>
**3/4/2026** <br> 
...
![img12](journal_images/1772597232990-d6qvl3.png)
![img11](journal_images/1772597243264-4meq4g.png)
<br> <br>
**3/4/2026** <br>
**Finished the 3D model of the toolhead cover - 2h** <br>
...
![img10](journal_images/1772595212941-a3uvbn.webp)
![img9](journal_images/1772595219518-upjs9j.webp)
![img8](journal_images/1772595225038-grb5ic.webp)
![img7](journal_images/1772595229315-vhdccx.webp)
![img6](journal_images/1772595233508-6p857j.webp)
![img5](journal_images/1772595238908-mqm6wi.webp)

**3/3/2026** <br>
**Took measurements and modeled the toolhead cover - 2.5h** <br>
...
![img4](journal_images/1772593606290-cia386.webp)
...
![img3](journal_images/1772593633540-ui84hr.webp)
...
![img2](journal_images/1772593669693-ct24ag.png)
![img1](journal_images/1772593690331-te786i.png)
